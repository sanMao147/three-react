...
export const rooms = [
  {
    name: '客厅',
    key: 'living-room',
    map: new URL('@/assets/textures/house/ballroom.jpg', import.meta.url).href,
    showSwitch: true,
  ...
  },
  {
    name: '卧室',
    key: 'bed-room',
    map: new URL('@/assets/textures/house/lythwood.jpg', import.meta.url).href,
    showSwitch: true,
  ...
  },
  {
    name: '室内泳池',
    key: 'pool-room',
    map: new URL('@/assets/textures/house/pool.jpg', import.meta.url).href,
    showSwitch: true,
    position: new Vector3(32, 0, 0)
    // interactivePoints: [
    //   {
